...
const Login = () => {
    ...
    return (
        <form className="login" onSubmit={handleSubmit}>
            ...
            {!isPending && <button className="bg-primary border-0 p-3 text-[#fff] font-body rounded cursor-pointer transition-transform  hover:scale-110 hover:bg-[#4edeb5]">Log in</button>}
