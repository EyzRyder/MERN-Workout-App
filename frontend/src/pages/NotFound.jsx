    ...
    return (
        <div className="flex items-center flex-col justify-center lg:flex-row py-28 px-6 md:px-24 md:py-20 lg:py-32 gap-16 lg:gap-28">
            ...
            <div className="w-full lg:w-1/2">
                ...
                <p className="py-2 text-base mb-5 text-gray-800">Sorry about that! Please visit our homepage to get where you need to go.</p>
                <Link to='/' className="w-full lg:w-auto my-4 border rounded-md px-1 sm:px-16 py-5 bg-primary text-white hover:bg-[#176750] focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:ring-opacity-50">Go back to Homepage</Link>
            </div>
        </div>
    );
};
